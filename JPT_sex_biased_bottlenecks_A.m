...
JPT_male_bottleneck=1100;
JPT_female_bottleneck=1000;
...
output_matrix=dataset({output_matrix 'mean','percentile_2pt5','median','percentile_97pt5'}, ...
              'obsnames', {'theta_w','pi'});
output_filename=['JPT_A_output_' int2str(2*JPT_male_bottleneck+2*JPT_female_bottleneck) 'autosomes_' int2str(runs) 'runs.txt']
