...
max_males=10000;
max_females=10000;
GIH_male_bottleneck=160;
GIH_female_bottleneck=100;
...
output_matrix=dataset({output_matrix 'mean','percentile_2pt5','median','percentile_97pt5'}, ...
              'obsnames', {'theta_w','pi'});
output_filename=['GIH_X_output_' int2str(GIH_male_bottleneck+2*GIH_female_bottleneck) 'Xchrom_' int2str(runs) 'runs.txt'];
