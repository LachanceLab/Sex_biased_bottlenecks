...
CHB_male_bottleneck=1050;
CHB_female_bottleneck=500;
...
output_matrix=dataset({output_matrix 'mean','percentile_2pt5','median','percentile_97pt5'}, ...
              'obsnames', {'theta_w','pi'});
output_filename=['CHB_A_output_' int2str(2*CHB_male_bottleneck+2*CHB_female_bottleneck) 'autosomes_' int2str(runs) 'runs.txt']
